                        ...
                        <div className="card">
                            ...
                            <form onSubmit={(e) => handleSubmit(e)}>
                                ...
                                <div data-mdb-input-init className="form-outline mb-4">
                                    ...
                                    <input type="text" id="" className="form-control form-control-lg" value={name}
                                        onChange={(e) => setName(e.target.value)} />
                                </div>

                                <div data-mdb-input-init className="form-outline mb-4">
                                    <label className="form-label" for="">Email</label>
                                    <input type="email" id="" className="form-control form-control-lg" value={email}
                                        onChange={(e) => setEmail(e.target.value)} />
                                </div>

                                <div data-mdb-input-init className="form-outline mb-4">
                                    <label className="form-label" for="">Password</label>
                                    <input type="password" id="" className="form-control form-control-lg" value={password}
                                        onChange={(e) => setPassword(e.target.value)} />
                                </div>

                                <div data-mdb-input-init className="form-outline mb-4">
                                    <label className="form-label" for="">Phone Number</label>
                                    <input type="tel" name="phone" id="phone" className="form-control form-control-lg" value={phoneNumber}
                                ...
                                <div className='d-flex mb-4 row'>
                                    ...
                                    <div className='d-flex'>
                                        <div class="form-check d-flex flex-row align-items-center mx-4 ">
                                            <input class="form-check-input me-2 border border-1 border-black" type="radio" name="flexRadioDefault" id="flexRadioDefault1" onChange={() => setSmoking(true)} />
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                YES
                                            </label>
                                        </div>
                                        <div class="form-check d-flex flex-row align-items-center">
                                            <input class="form-check-input me-2 border border-1 border-black" type="radio" name="flexRadioDefault" id="flexRadioDefault1" onChange={() => setSmoking(false)} />
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                NO
                                            </label>
                                        </div>
                                ...
                                <div className='d-flex align-items-center justify-content-around'>
                                    ...
                                    <button class="btn " type="submit">
                                            <Link to='/checkforapprove' class="btn btnRegister m-2 ">
                                            Register
                                            </Link>
                                        </button>
